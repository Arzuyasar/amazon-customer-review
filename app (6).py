...
def ozet_cikar(metin, cumle=2):
    """
    Claude API ile abstractive ozetleme.
    """
    import requests
            ...
            json={
                ...
                "messages": [{
                    ...
                    "content": (
                        ...
                        "Focus on the main problem and what the customer experienced. "
                        "Be concise and clear. Do not copy sentences directly.\n\n"
                        "Review: " + metin[:800]
                    )
                }]
            },
